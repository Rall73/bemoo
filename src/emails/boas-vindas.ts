...
<head>
  ...
  <title>Bem-vindo ao bemoo</title>
</head>
<body style="margin:0;padding:0;background:#F8F9FB;font-family:'Inter',system-ui,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 16px;">
    <tr>
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;border:1px solid #D9DEE3;overflow:hidden;">
          ...
          <!-- Header -->
          <tr>
            <td style="background:#1F4E4A;padding:32px 40px;">
          ...
          <tr>
            <td style="padding:40px;">
              <h1 style="margin:0 0 8px;font-size:22px;font-weight:600;color:#1A1F23;">Olá, ${nome}!</h1>
              <p style="margin:0 0 24px;font-size:15px;color:#4A5057;line-height:1.6;">
                A empresa <strong>${empresa}</strong> foi criada com sucesso no bemoo.
                Você já pode acessar a plataforma e configurar os módulos que precisa.
              </p>
              ...
              <p style="margin:0;font-size:13px;color:#8D9298;line-height:1.6;">
          ...
          <!-- Footer -->
          <tr>
            <td style="padding:20px 40px;background:#F8F9FB;border-top:1px solid #D9DEE3;">
              <p style="margin:0;font-size:12px;color:#8D9298;">
                © ${new Date().getFullYear()} bemoo · <a href="${url}/privacidade" style="color:#8D9298;">Privacidade</a>
              </p>
            </td>
          </tr>
    ...
    text: `Bem-vindo ao bemoo, ${nome}!\n\nA empresa ${empresa} foi criada com sucesso.\n\nAcesse: ${url}/dashboard`,
  }
}
