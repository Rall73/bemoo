...
import {
  ...
  Package, Settings2, CalendarDays, ClipboardList,
} from "lucide-react"
            ...
            {navModules.map((mod) => {
              ...
              return (
                <div key={mod.key}>
                  ...
                  {mod.key === "efetivo" && (
                    <>
                      <NavLink href="/efetivo/chamada"       icon={ClipboardList} label="Chamada"       current={pathname} onClick={handleLinkClick} indent />
